...
return { -- Fuzzy Finder (files, lsp, etc)
  ...
  dependencies = {
    ...
    { -- NOTE: not working
      ...
      lazy = true,
      keys = {
        { '<leader>ss', '<cmd>Telescope luasnip<cr>', desc = '[S]earch Available [S]nippets for Filetype' },
      },
      config = function()
  ...
  config = function()
    ...
    set('n', '<leader><leader>', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
    ...
    -- Shortcut for grepping quickfix list
    set('n', '<leader>sq', builtin.quickfix, { desc = '[S]earch [Q]uickfix List' })
    -- set('n', '<leader>ss', function()
    --   require('telescope').extensions.luasnip.luasnip {}
    --   vim.cmd [[ Telescope luasnip ]]
    -- end, { desc = '[S]earch Available [S]nippets for Filetype' })
